...
- [spec.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/kv_offload/cpu/spec.py:17)
...
- [simple_cpu_offload_connector.py](/home/aoshen/setup_new_cluster/vllm/vllm/distributed/kv_transfer/kv_connector/v1/simple_cpu_offload_connector.py:69)
...
1. 生成 KV latent 的投影 `kv_a_proj_with_mqa` 是 `ReplicatedLinear`，不是 `ColumnParallelLinear`。这意味着每个 TP rank 都持有同一份权重，并各自算出同一份输出：
   - [kimi_linear.py](/home/aoshen/setup_new_cluster/vllm/vllm/model_executor/models/kimi_linear.py:217)
   - [linear.py](/home/aoshen/setup_new_cluster/vllm/vllm/model_executor/layers/linear.py:287)
...
也就是 replicated 投影产出的 `kv_c + k_pe`：
   - [mla.py](/home/aoshen/setup_new_cluster/vllm/vllm/model_executor/layers/mla.py:141)
   - [mla.py](/home/aoshen/setup_new_cluster/vllm/vllm/model_executor/layers/mla.py:147)
   - [mla.py](/home/aoshen/setup_new_cluster/vllm/vllm/model_executor/layers/mla.py:150)
...
对应代码：
   - [mla_attention.py](/home/aoshen/setup_new_cluster/vllm/vllm/model_executor/layers/attention/mla_attention.py:835)
   - [mla_attention.py](/home/aoshen/setup_new_cluster/vllm/vllm/model_executor/layers/attention/mla_attention.py:1132)
...
- [spec.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/kv_offload/cpu/spec.py:17)
- [cpu_gpu.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/kv_offload/worker/cpu_gpu.py:374)
...
- [simple_cpu_offload_connector.py](/home/aoshen/setup_new_cluster/vllm/vllm/distributed/kv_transfer/kv_connector/v1/simple_cpu_offload_connector.py:69)
- [simple_kv_offload/manager.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/simple_kv_offload/manager.py:159)
- [simple_kv_offload/worker.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/simple_kv_offload/worker.py:153)
...
- [offloading_connector.py](/home/aoshen/setup_new_cluster/vllm/vllm/distributed/kv_transfer/kv_connector/v1/offloading_connector.py:77)
- [offloading/worker.py](/home/aoshen/setup_new_cluster/vllm/vllm/distributed/kv_transfer/kv_connector/v1/offloading/worker.py:387)
...
- [simple_cpu_offload_connector.py](/home/aoshen/setup_new_cluster/vllm/vllm/distributed/kv_transfer/kv_connector/v1/simple_cpu_offload_connector.py:145)
- [simple_kv_offload/worker.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/simple_kv_offload/worker.py:221)
...
- [cpu/manager.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/kv_offload/cpu/manager.py:24)
...
- [simple_kv_offload/manager.py](/home/aoshen/setup_new_cluster/vllm/vllm/v1/simple_kv_offload/manager.py:369)
