...
```text
INFO 07-23 13:56:04 [kv_cache_planning.py:441] GPU KV cache size: 643,232 tokens
INFO 07-23 13:56:04 [kv_cache_planning.py:446] Maximum concurrency for 40,960 tokens per request: 15.70x
```
