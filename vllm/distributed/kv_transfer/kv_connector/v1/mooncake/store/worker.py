...
class KVCacheStoreSendingThread(KVTransferThread):
    ...
    def _handle_request(self, req_meta: ReqMeta):
        ...
        try:
            ...
            ends: list[int] = []
            keys: list[str] = []
            # event_spec: (start token, end token, cache group index, block hash).
...
class MooncakeStoreWorker:
    ...
    def _supports_tp_sharded_store_layout(
        ...
        # Keep the exact type check: MLA, R-SWA, sink attention, and packed
        # hybrid specs are outside the format implemented by this PR.
        return (
    ...
    def _select_store_layout(
        ...
        if (
            ...
            if self.num_kv_head == 1:
                # Replicated MQA ranks share one rank-zero key namespace.
    ...
    def _build_token_databases(
        ...
        """Construct token databases and their physical Store layouts."""
